...
def append_data(new_gdf: gpd.GeoDataFrame):
    ...
    try:
        ...
        if existing_gdf.empty:
            ...
            # Hapus OBJECTID dari new_gdf sebelum concat
        ...
        with tab1:
            ...
            if uploaded_file:
                try:
                    ...
                    with col1:
                        if st.button("➕ Tambah Data", use_container_width=True, type="primary"):
...
<div class="footer">
    ...
    <p style="font-size: 0.8rem;">Integrasi Dengan Google Drive ☁️</p>
</div>
""", unsafe_allow_html=True)
